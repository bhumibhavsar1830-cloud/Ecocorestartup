...
def create_pdf():
    ...
    data_table = [
        ...
        ["Estimated Cost", f"₹{int(cost)}"],
        ["Carbon Emission", f"{carbon:.2f} tons"],
        ["Potential Savings", f"₹{int(cost*0.15)}"]
    ]
    ...
    elements.append(Paragraph("High energy usage detected during peak hours.", styles['Normal']))
    elements.append(Spacer(1, 10))

    elements.append(Paragraph("<b>Recommendations</b>", styles['Heading2']))
    elements.append(Paragraph("- Reduce peak hour consumption", styles['Normal']))
    elements.append(Paragraph("- Optimize machine usage timing", styles['Normal']))
    elements.append(Paragraph("- Avoid idle running", styles['Normal']))
